...
public:
    ...
    Vektor3d &PostaviX(double x) { Vektor3d::koordinate[0] = x; return *this;}
...
int main () {
    ...
    std::cout << "\nKoordinata x uvecana za 100, kod vektora v1 iznosi: ";
    v1.PostaviX(v1.DajX() + 100).Ispisi();
    std::cout << ", a v2: ";
    v2.PostaviX(v2.DajX() + 100).Ispisi();
	return 0;
}